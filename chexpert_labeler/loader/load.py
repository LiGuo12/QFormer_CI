...
from negbio2.negbio.pipeline2 import ssplit
from negbio2.negbio.pipeline2.section_split import SectionSplitter
from negbio2.negbio.ext import text2bioc
...
class Loader(object):
    ...
    def extract_sections(self, document):
        ...
        split_document = splitter(document)
        passages = []
