...
base_Qf =       [0.5610, 0.9119, 0.7814, 0.9678, 0.8780, 0.9576, 0.9271, 0.9864, 0.9458, 0.9915, 0.9559, 0.9831, 0.9559, 0.9542]
...
# 绘制每组模型的曲线
ax.plot(angles, non_causal_model, color='orange', linewidth=2, label='Q-former')
ax.fill(angles, non_causal_model, color='orange', alpha=0.25)

ax.plot(angles, vlci_model, color='green', linewidth=2, label='Q-former + CI')
ax.fill(angles, vlci_model, color='green', alpha=0.25)
